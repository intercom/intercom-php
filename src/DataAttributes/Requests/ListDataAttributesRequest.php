...
use Intercom\DataAttributes\Types\DataAttributesListRequestModel;

class ListDataAttributesRequest extends JsonSerializableType
{
    /**
     * @var ?value-of<DataAttributesListRequestModel> $model Specify the data attribute model to return.
     */
    ...
    /**
     * @param array{
     *   model?: ?value-of<DataAttributesListRequestModel>,
    ...
    /**
     * @return ?value-of<DataAttributesListRequestModel>
     */
    ...
    /**
     * @param ?value-of<DataAttributesListRequestModel> $value
     */
