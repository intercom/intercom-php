...
namespace Intercom\Unstable\TicketStates;

use GuzzleHttp\ClientInterface;
use Intercom\Core\Client\RawClient;
use Intercom\Unstable\Types\TicketStateList;
...
class TicketStatesClient
{
     ...
     */
    public function listTicketStates(?array $options = null): TicketStateList
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return TicketStateList::fromJson($json);
            }
