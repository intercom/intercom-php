...
namespace Intercom\Unstable\Contacts\Traits;

use Intercom\Unstable\Contacts\Types\ContactAvatar;
...
trait Contact
{
    ...
    /**
     * @param ?ContactAvatar $value
     */
    public function setAvatar(?ContactAvatar $value = null): self
    {
        $this->avatar = $value;
        return $this;
    }
