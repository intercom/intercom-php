...
namespace Intercom\Unstable\Admins;

use GuzzleHttp\ClientInterface;
use Intercom\Core\Client\RawClient;
use Intercom\Unstable\Types\AdminWithApp;
...
use Intercom\Unstable\Admins\Requests\SetAwayAdminRequest;
use Intercom\Unstable\Admins\Types\Admin;
use Intercom\Unstable\Admins\Requests\ListActivityLogsRequest;
use Intercom\Unstable\Types\ActivityLogList;
use Intercom\Unstable\Types\AdminList;
use Intercom\Unstable\Admins\Requests\RetrieveAdminRequest;
...
class AdminsClient
{
     ...
     */
    public function identifyAdmin(?array $options = null): ?AdminWithApp
    {
     ...
     *
     * @param SetAwayAdminRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws IntercomApiException
     */
    public function setAwayAdmin(SetAwayAdminRequest $request, ?array $options = null): ?Admin
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::UsProduction->value,
                    path: "admins/{$request->getId()}/away",
     ...
     * @throws IntercomApiException
     */
    public function listActivityLogs(ListActivityLogsRequest $request, ?array $options = null): ActivityLogList
    {
        $options = array_merge($this->options, $options ?? []);
        $query = [];
     ...
     * @throws IntercomApiException
     */
    public function listAdmins(?array $options = null): AdminList
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     *
     * @param RetrieveAdminRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws IntercomApiException
     */
    public function retrieveAdmin(RetrieveAdminRequest $request, ?array $options = null): ?Admin
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
