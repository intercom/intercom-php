...
{
    /**
     * @var ?string $jobIdentfier The identifier for your job.
     */
    #[JsonProperty('job_identfier')]
    private ?string $jobIdentfier;
    ...
    public function __construct(
        ...
        $this->jobIdentfier = $values['jobIdentfier'] ?? null;
     ...
     * @return ?string
     */
    public function getJobIdentfier(): ?string
    {
        return $this->jobIdentfier;
    }

    /**
     * @param ?string $value
     */
    public function setJobIdentfier(?string $value = null): self
    {
        $this->jobIdentfier = $value;
        return $this;
    }
