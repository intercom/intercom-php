...
use Intercom\Unstable\DataEvents\Types\CreateDataEventSummariesRequestEventSummaries;

class CreateDataEventSummariesRequest extends JsonSerializableType
{
    /**
