...
namespace Intercom\Unstable\AiContent;

use GuzzleHttp\ClientInterface;
use Intercom\Core\Client\RawClient;
use Intercom\Unstable\AiContent\Types\ContentImportSourcesList;
...
use Intercom\Unstable\AiContent\Requests\CreateContentImportSourceRequest;
use Intercom\Unstable\AiContent\Types\ContentImportSource;
use Intercom\Unstable\AiContent\Requests\GetContentImportSourceRequest;
use Intercom\Unstable\AiContent\Requests\UpdateContentImportSourceRequest;
use Intercom\Unstable\AiContent\Requests\DeleteContentImportSourceRequest;
use Intercom\Unstable\AiContent\Types\ExternalPagesList;
use Intercom\Unstable\AiContent\Requests\CreateExternalPageRequest;
use Intercom\Unstable\AiContent\Types\ExternalPage;
use Intercom\Unstable\AiContent\Requests\GetExternalPageRequest;
use Intercom\Unstable\AiContent\Requests\UpdateExternalPageRequest;
use Intercom\Unstable\AiContent\Requests\DeleteExternalPageRequest;
    ...
    public function getContentImportSource(GetContentImportSourceRequest $request, ?array $options = null): ContentImportSource
    {
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::UsProduction->value,
                    path: "ai/content_import_sources/{$request->getId()}",
                    method: HttpMethod::GET,
                ),
                $options,
            );
    ...
    public function getExternalPage(GetExternalPageRequest $request, ?array $options = null): ExternalPage
    {
        ...
        try {
            $response = $this->client->sendRequest(
                new JsonApiRequest(
                    baseUrl: $options['baseUrl'] ?? $this->client->options['baseUrl'] ?? Environments::UsProduction->value,
                    path: "ai/external_pages/{$request->getId()}",
                    method: HttpMethod::GET,
                ),
                $options,
            );
