 ...
 */
class AdminReplyConversationRequest extends JsonSerializableType
{
    /**
     * @var value-of<AdminReplyConversationRequestMessageType> $messageType
     */
    ...
    /**
     * @param array{
     *   messageType: value-of<AdminReplyConversationRequestMessageType>,
     *   type: 'admin',
     *   adminId: string,
     *   body?: ?string,
     *   createdAt?: ?int,
    ...
    /**
     * @return value-of<AdminReplyConversationRequestMessageType>
     */
    ...
    /**
     * @param value-of<AdminReplyConversationRequestMessageType> $value
     */
