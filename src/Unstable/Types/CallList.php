 ...
 */
class CallList extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<Call> $data A list of calls.
     */
    #[JsonProperty('data'), ArrayType([Call::class])]
    private ?array $data;

    /**
     * @var ?int $totalCount Total number of items available.
     */
