 ...
 */
class TicketStateDetailedTicketTypes extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<?TicketType> $data A list of ticket type attributes associated with a given ticket type.
     */
