...
class DetachSubscriptionTypeToContactRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var string $id The unique identifier for the subscription type which is given by Intercom
     */
    private string $id;
