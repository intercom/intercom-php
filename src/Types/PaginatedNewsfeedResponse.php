 ...
 */
class PaginatedNewsfeedResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var int $totalCount A count of the total number of Newsfeeds.
     */
    #[JsonProperty('total_count')]
    private int $totalCount;

    /**
     * @var array<Newsfeed> $data An array of Newsfeeds
     */
    #[JsonProperty('data'), ArrayType([Newsfeed::class])]
    private array $data;
